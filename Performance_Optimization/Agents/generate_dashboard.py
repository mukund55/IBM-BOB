    ...
    <div class="container">
        ...
        <div class="summary-cards">
            ...
            <div class="card">
                ...
                <div class="card-value">{checkpoints_passed}/{checkpoints_applicable}</div>
                <div class="card-subtitle">{completion_percentage}% Complete</div>
            </div>
...
def generate_dashboard(json_file: Path, output_file: Path) -> None:
    ...
    replacements = {
        ...
        '{checkpoints_passed}': str(checkpoints_passed),
        '{checkpoints_applicable}': str(checkpoints_applicable),
